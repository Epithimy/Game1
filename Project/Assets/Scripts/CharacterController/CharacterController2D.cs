...
public class CharacterController2D : MonoBehaviour
{
	...
	//[SerializeField] float maxVelocity = 40f;		// A collider that will be disabled when crouching
	...
	private void FixedUpdate()
	{
		...
		//		m_Rigidbody2D.velocity.magnitude = maxVelocity;
